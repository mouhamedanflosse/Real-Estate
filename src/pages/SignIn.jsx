  ...
  return (
    <div className="relative mt-[80px]">
      ...
      <div className="max-w-6xl mx-auto flex gap-6 justify-center items-center ">
        <Lottie className="w-[50%] hidden Xmd:block" animationData={animationData}/>
        <div className="grow">
          ...
          <Form className="flex flex-col items-center gap-2 w-fit mx-auto ">
            ...
            <Link to="/forget-password" className="self-start pl-[10px] select-none"><p className="cursor-pointer text-lg text-blue-500">
              forget password ?{" "}
            </p></Link>
              {/* <div className=""  >
